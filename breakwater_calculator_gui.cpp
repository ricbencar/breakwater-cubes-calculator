...
public:
    ...
    BreakwaterCalculator() {
        ...
        standard_gradings = {
            {L"EN 13383 LMA 5-40 kg",     5,    40},
            {L"EN 13383 LMA 10-60 kg",    10,   60},
            {L"EN 13383 LMA 40-200 kg",   40,   200},
            {L"EN 13383 LMA 60-300 kg",   60,   300},
            {L"EN 13383 HMA 300-1000 kg", 300,  1000},
            {L"EN 13383 HMA 1-3 ton",     1000, 3000},
            {L"EN 13383 HMA 3-6 ton",     3000, 6000},
            {L"EN 13383 HMA 6-10 ton",    6000, 10000}
        };
