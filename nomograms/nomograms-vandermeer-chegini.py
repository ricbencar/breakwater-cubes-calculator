...
NOMOGRAM_CONFIGS = [
    # 1. Van Der Meer (1988) - Cubes (Slope 2.0:1)
    {
        ...
        "params": {
            "p1": 6.7 * vdm_slope_correction,  # k1 * C (Direct proportionality)
            "p2": 0.4,                         # k2
            "p3": 0.3,                         # k3
            "p4": 1.0 * vdm_slope_correction,  # k4 * C
            "p5": 0.1                          # k5
        },
        "title": (
            r"1. Van Der Meer (1988a) - Cubes (Slope 2.0:1)" + "\n\n" +
            r"$N_s = \frac{H_s}{\Delta D_n} = (k_1 N_{od}^{k_2}/N_z^{k_3} + k_4) s_{om}^{-k_5} (2.0/1.5)^{1/3}$" + "\n" +
            r"(Eq. used in Calculator: $k_1=6.7, k_4=1.0$)"
        )
    },
    ...
    # 2. Van Der Meer (1988) - Cubes (Slope 1.5:1)
    {
        ...
        "title": (
            ...
            r"$k_1=6.7; k_2=0.4; k_3=0.3; k_4=1.0; k_5=0.1$"
        )
    },
